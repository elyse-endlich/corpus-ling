# Hello! This was my final project for my Corpus Linguistics class. I conducted a discourse analysis of various generational terms on Twitter, Google, and Google Scholar.
...
searchcolumns <- function(x) x[, c("�..Title", "Description")]
...
BoomerSearchResults$�..Title <- fixpunct(BoomerSearchResults$�..Title)
BoomerSearchResults$Description <- fixpunct(BoomerSearchResults$Description)

GenZSearchResults$�..Title <- fixpunct(GenZSearchResults$�..Title)
GenZSearchResults$Description <- fixpunct(GenZSearchResults$Description)

MillennialSearchResults$�..Title <- fixpunct(MillennialSearchResults$�..Title)
MillennialSearchResults$Description <- fixpunct(MillennialSearchResults$Description)

GoogleScholar$�..Title <- fixpunct(GoogleScholar$�..Title)
...
data_counts$frequency_norm <- frequency_norm # make new column

# Top ten keywords in each set, ranked by log-likelihood "keyness" metric, using the rest of the data as the baseline
